...
def main():
    ...
    ap.add_argument("--agent", type=str, default='DQNConcat',
    ...
    ap.add_argument("--map", type=str, default='grid4x4',
                    choices=['grid4x4', 'arterial4x4', 'ingolstadt1', 'ingolstadt7', 'ingolstadt21',
                             'cologne1', 'cologne3', 'cologne8', 'baoding', '30min', '15min', '4x4'
                             ])
        ...
        for t in range(args.eps):
            ...
            while not done:
                ...
                for step in range(env.yellow_length):
                    ...
                    for in_sig in intention:
                        intention_log[in_sig].append(intention[in_sig])
